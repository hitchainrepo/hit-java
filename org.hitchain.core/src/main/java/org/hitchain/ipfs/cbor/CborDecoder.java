...
import static org.hitchain.ipfs.cbor.CborConstants.*;
import static org.hitchain.ipfs.cbor.CborType.getName;
import static org.hitchain.ipfs.cbor.CborType.valueOf;
...
public class CborDecoder {
    ...
    private static void fail(String msg, Object... args) throws IOException {
        throw new IOException(msg + (args == null ? null : Arrays.toString(args)));
    }
