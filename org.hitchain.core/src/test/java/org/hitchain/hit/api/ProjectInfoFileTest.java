...
public class ProjectInfoFileTest {
    ...
    public static final String PIF_CONTENT = "" +
            "\n" +
            "{\n" +
            "  \"version\": \"1\",\n" +
    ...
    public void createProjectInfoFile() throws Exception {
        ...
        //
        String expected = info.genSignedContent(WalletHelper.decryptWithPasswordHex(rsaPri, password));
        System.out.println(expected);
        Assert.assertEquals(expected, PIF_CONTENT);
    }
